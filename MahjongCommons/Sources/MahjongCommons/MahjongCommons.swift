...
extension Entity {/// Returns the position of the entity specified in the app's coordinate system. On
    ...
    public func applyMaterial(_ material: Material) {
    ...
    public var extents: SIMD3<Float> { visualBounds(relativeTo: self).extents }
...
public extension SIMD3 where Scalar == Float {
    ...
    public static let rotate_x = SIMD3<Float>(x: 1, y: 0, z: 0)
    public static let rotate_y = SIMD3<Float>(x: 0, y: 1, z: 0)
    public static let rotate_z = SIMD3<Float>(x: 0, y: 0, z: 1)
    ...
    public static let zero = SIMD3<Float>.zero
}
